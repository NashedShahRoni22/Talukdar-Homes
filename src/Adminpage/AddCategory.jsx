...
export default function AddCategory() {
  ...
  const deleteCategory = async (categoryId) => {
    try {
      const response = await fetch(`https://api.talukderhomes.com.au/api/categories/delete/${categoryId}`, {
        ...
        {category.map((c, i) => (
          ...
          >
            <div className="bg-primary text-white p-2.5 flex justify-between items-center">
              ...
              <button onClick={()=> deleteCategory(c?.id)} className="p-2 shadow rounded-full bg-gray-50 text-red-500">
              ...
              {c?.children?.map((cc, k) => (
                ...
                >
                  ...
                  <div>
                    ...
                    <button onClick={()=> deleteCategory(c?.id)} className="p-1.5 rounded-full hover:bg-red-100">
