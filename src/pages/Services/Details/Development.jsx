...
export default function Development() {
  ...
  const data = {
    ...
    slug: "architecture",
    title:
      "We offer commitment at all levels of building project, from architecture to management services.",
    desc: "Across this diversity, one thing all our clients share is the trust they put in us to manage and deliver architecture projects of the highest quality, on time and on budget – it’s what we’ve built our reputation on.",
    addonsDesc: "From concept and building design to project and architecture management, our flexible, multi-skilled team provides comprehensive, innovative, forward-thinking solutions. And as your architecture partner, our services can even extend to helping you acquire and develop land to deliver one streamlined package of work, eliminating the headache of extra administrative steps",
    features: {
      title:
      ...
      details: [
        {
          ...
          desc: "Focusing on medium to large-scale commercial architecture projects, we work with both investors and developers to create landmarks that make an impact.",
        },
        {
          topic: "Quality & Reliable",
          desc: "Focusing on medium to large-scale commercial architecture projects, we work with both investors and developers to create landmarks that make an impact.",
